 ...
 *  1. AoManager subscribe all AOs from [aoSet] to [EventBus]
 *  2. After [ActiveObject] instance subscribed to [EventBus] it sends an event [SubscriptionCompleteEvent]
...
) : ActiveObject(AoManagerEventFilter(), eventBus, context) {

    private val stateMachine = AoManagerStateMachine(aoSet, eventBus)
