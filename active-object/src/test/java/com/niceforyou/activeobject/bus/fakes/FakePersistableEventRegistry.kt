...
internal class FakePersistableEventRegistry : PersistableEventRegistry {
    ...
    var deleteStickyPartitionCount = 0
    var deleteStickyPartitionCollectionCount = 0
    var readStickyCallCount = 0
    var readStickyPartitionCallCount = 0
    var readStickyCollectionCallCount = 0
    var readStickyPartitionCollectionCallCount = 0
